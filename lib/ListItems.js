...
class ListItemsLib {
    ...
    async deleteItem(listItemId, userId) {
        ...
        if (!listItem) {
            throw new Error('List item does not exist')
        }

        if (listItem.is_resolved) {
            throw new Error('List item has already been resolved')
        }
    ...
    async changeItemPriority(listItemId, userId, newPriorityId) {
        ...
        if (listItem.Priority_id === newPriorityId) {
            throw new Error('New Priority can not be the same as Old Priority')
        }
    ...
    async updateListItem(listItemId, userId, payload) {
        ...
        if (!isListMember) {
            throw new Error(`User ID ${userId} is not a member of List`)
        }
